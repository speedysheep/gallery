// Downloads every video referenced in sites/<site>/public/gallery.json into sites/<site>/public/videos/, purely so
// a local copy exists on this machine — sites/<site>/public/videos/ is git-ignored and R2 is the real
...
async function main() {
	...
	console.log(`Checking ${videos.length} video entries against sites/<site>/public/videos/...`);

...
// poster, or R2 object, or to remove an entry from sites/<site>/public/gallery.json. Every other
...
/**
 * Deletes one photo: sites/<site>/public/pictures/<pictureName>, its thumbnail, and its gallery.json
...
export async function deletePictureEntry(pictureName, { dryRun = false } = {}) {
	...
	if (!manifest) throw new Error("Couldn't read sites/<site>/public/gallery.json — refusing to delete anything.");
 ...
 * sites/<site>/public/videos/ if present, its poster, its .media-cache.json bookkeeping, and its

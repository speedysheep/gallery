...
// final names.
//
// "New" means "not already referenced by sites/<site>/public/gallery.json" — photos by filename,
...
// handed out twice (sites/<site>/public/thumbs/<n>.jpg is a URL, and a reused one would collide with a
...
async function main() {
	...
	if (!manifest) {
		console.error("Couldn't read sites/<site>/public/gallery.json — refusing to rename anything.");
